...
# Optional: specify a Python environment
use_python("/usr/bin/python3")  # or your local path
```
...
-   Aide à comprendre le **combien**, **à quelle fréquence**, le **pour qui**

------------------------------------------------------------------------

## Les méthodes quantitatives et les statistiques

::: {.callout-tip title="Explication"}
