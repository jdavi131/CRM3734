...
ggplot() +
  ...
  annotate("text", x = 0, y = 0,   label = "Statistiques",          size = 4.5) +
  annotate("text", x = 0, y = 2.5, label = "Méthodes quantitatives", size = 4.5) +
...
ggplot() +
  geom_circle(aes(x0 = 0, y0 = 0, r = 2), color = "black", fill = NA, linewidth = 0.5) +
  geom_circle(aes(x0 = 0, y0 = 0, r = 1), color = "black", fill = NA, linewidth = 0.5) +
  annotate("text", x = 0, y = 0,   label = "Les infractions déclarées", size = 4) +
  annotate("text", x = 0, y = 2.5, label = "Ensemble des infractions",  size = 4) +
  coord_fixed(xlim = c(-3.5, 3.5), ylim = c(-3, 3.5)) +
  theme_void()
```
...
ggplot() +
  ...
  annotate("text", x = 4.2, y =  2.8, label = "Phénomène social plus large",                    hjust = 0, fontface = "bold", size = 3.5) +
  annotate("text", x = 4.2, y =  2.2, label = "Actes, expériences, incidents réels",            hjust = 0, size = 3, color = "#555") +
  annotate("text", x = 4.2, y =  0.3, label = "Partie portée à l'attention des institutions",   hjust = 0, fontface = "bold", size = 3.5) +
  annotate("text", x = 4.2, y = -0.3, label = "Signalements, prises en charge, enregistrements", hjust = 0, size = 3, color = "#555") +
  annotate("text", x = 4.2, y = -2.2, label = "Statistiques officielles",                       hjust = 0, fontface = "bold", size = 3.5) +
  annotate("text", x = 4.2, y = -2.8, label = "Ce qui devient effectivement compté",            hjust = 0, size = 3, color = "#555") +
...
ggplot() +
  ...
  annotate("text", x = 2.25, y = 4.5, label = "Petit échantillon",                fontface = "bold", size = 4.5) +
  annotate("text", x = 2.25, y = 3.9, label = "Quelques observations seulement",  size = 3.2, color = "#666") +
  annotate("text", x = 2.25, y = 2.7, label = "Un petit nombre de cas peut\nmodifier fortement l'impression générale.", size = 3.2, lineheight = 1.3) +
  annotate("text", x = 7.75, y = 4.5, label = "Grand échantillon",                fontface = "bold", size = 4.5) +
  annotate("text", x = 7.75, y = 3.9, label = "Beaucoup plus d'observations",     size = 3.2, color = "#666") +
  annotate("text", x = 7.75, y = 2.7, label = "Le portrait devient plus stable,\nplus robuste, moins sensible à quelques cas.", size = 3.2, lineheight = 1.3) +
...
ggplot() +
  ...
  annotate("text", x = 1.65, y = 5.0, label = "Population",          fontface = "bold", size = 4) +
  annotate("text", x = 5.45, y = 5.0, label = "Unités sélectionnées", fontface = "bold", size = 4) +
  annotate("text", x = 8.65, y = 5.0, label = "Échantillon observé",  fontface = "bold", size = 4) +
...
ggplot() +
  ...
  annotate("text", x = 5,    y = 4.25, label = "Taille de la ville",             fontface = "bold", size = 4.5) +
  annotate("text", x = 2,    y = 0.75, label = "Plus de policiers",              size = 4) +
  annotate("text", x = 8,    y = 0.75, label = "Plus d'infractions enregistrées", size = 4) +
