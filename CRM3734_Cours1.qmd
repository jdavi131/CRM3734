...
<div style="display:flex; justify-content:center; align-items:center;">
  <svg width="700" height="700" viewBox="-3.5 -2.1 7 7" xmlns="http://www.w3.org/2000/svg">
    <circle cx="0" cy="0" r="2" fill="none" stroke="black" stroke-width="0.06"/>
    <circle cx="0" cy="0" r="1" fill="none" stroke="black" stroke-width="0.06"/>
    <text x="0" y="0.05" text-anchor="middle" dominant-baseline="middle" font-size="0.30" font-family="Arial, sans-serif">Statistiques</text>
    <text x="0" y="2.4" text-anchor="middle" dominant-baseline="middle" font-size="0.30" font-family="Arial, sans-serif">Méthodes quantitatives</text>
  </svg>
</div>
```
...
```{=html}
<div style="display:flex; justify-content:center; align-items:center;">
  <svg width="525" height="525" viewBox="-3.5 -3.5 7 7" xmlns="http://www.w3.org/2000/svg">
    <circle cx="0" cy="0" r="2" fill="none" stroke="black" stroke-width="0.08"/>
    <circle cx="0" cy="0" r="1" fill="none" stroke="black" stroke-width="0.08"/>
    <text x="0" y="0.05" text-anchor="middle" dominant-baseline="middle" font-size="0.63" font-family="Arial, sans-serif">Les infractions déclarées</text>
    <text x="0" y="2.4" text-anchor="middle" dominant-baseline="middle" font-size="0.63" font-family="Arial, sans-serif">Ensemble des infractions</text>
  </svg>
</div>
```
